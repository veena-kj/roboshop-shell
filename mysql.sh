...
func_heading "Start using mysql services with new root creds- Reset MySQL Password"
/usr/sbin/mysql_secure_installation --set-root-pass $mysql_root_password  &>>$log_file
func_status_check $?
